...
C     Modified field centres for 2021 search location.
      field_centre(5, 1) = 288.3845
      field_centre(5, 2) = -20.9591
      field_centre(6, 1) = 287.8368
      field_centre(6, 2) = -20.1401
...
C     but not in radius for any of the previous fields.
            ...
            do k = 1, i
                ...
                obs_dec = 0
                do field_number = 1, 2
                   obs_ra = obs_ra + field_centre(((k-1)*2 +
     $                  field_number), 1)*drad
                   obs_dec = obs_dec + field_centre(((k-1)*2 +
     $                  field_number), 2)*drad
                end do
                obs_ra = obs_ra/2.0
                obs_dec = obs_dec/2.0
